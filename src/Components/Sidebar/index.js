                ...
                <div class="h-full px-3 py-4 overflow-y-auto bg-high_grey">
                    <ul class="space-y-2">
                        ...
                        <li>
                            ...
                            <span class="ml-3 whitespace-nowrap">Adicionar Usuário</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="flex items-center p-1 text-black rounded-lg hover:bg-orange group">
                            ...
                            <span class="ml-3 whitespace-nowrap">Assistidos</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="flex items-center p-1 text-black rounded-lg hover:bg-orange group">
                            ...
                            <span class="ml-3 whitespace-nowrap">Agendamentos</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="flex items-center p-1 text-black rounded-lg hover:bg-orange group">
                            ...
                            <span class="ml-3 whitespace-nowrap">Pastas</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="flex items-center p-1 text-black rounded-lg hover:bg-orange group">
